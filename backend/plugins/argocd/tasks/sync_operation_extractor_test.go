...
func TestResolveGitRepoURL_SingleSource(t *testing.T) {
	...
	got := resolveGitRepoURL("https://github.com/liveramp/cvv-fe", nil)
	assert.Equal(t, "https://github.com/liveramp/cvv-fe", got)
}

func TestResolveGitRepoURL_MultiSourceGitHubWins(t *testing.T) {
	// Typical MTTN pattern: GCS chart + GitHub values ref.
	sources := []ArgocdApiSyncSource{
		{RepoURL: "gs://charts-liveramp-net/infra/stable", Chart: "generic-service"},
		{RepoURL: "https://github.com/liveramp/cvv-fe"},
	}
...
func TestResolveGitRepoURL_AllChartSources(t *testing.T) {
	...
	sources := []ArgocdApiSyncSource{
		{RepoURL: "gs://charts-liveramp-net/infra/stable"},
		{RepoURL: "oci://registry.example.com/charts"},
	}
	got := resolveGitRepoURL("", sources)
	assert.Equal(t, "", got)
...
func TestIsGitHostedURL(t *testing.T) {
	...
	assert.False(t, isGitHostedURL("gs://charts-liveramp-net/infra/stable"))
